...
public class KeyStoreTest {
    ...
    public void testDecrypt() throws CryptoException, InvalidKeyException {
        ...
        // Decrypt
        this.ks = new KeyStore(this.cryptoProvider, privateKey);
    ...
    public void testDecryptFails() throws InvalidKeyException, CryptoException {
        // Encrypt data
        final byte[] in = "hello".getBytes();
        final byte[] nonce = new byte[CryptoProvider.NONCEBYTES];
        final byte[] otherKey = new byte[CryptoProvider.PUBLICKEYBYTES];
    ...
    public void testInvalidKey() throws InvalidKeyException, CryptoException {
        final byte[] in = "hello".getBytes();
        final byte[] nonce = new byte[CryptoProvider.NONCEBYTES];
    ...
    @Test
    public void testHexConstructor() throws CryptoException {
        ...
        final KeyStore ks1 = new KeyStore(this.cryptoProvider, bytes);
        final KeyStore ks2 = new KeyStore(this.cryptoProvider, hex);
        assertArrayEquals(ks1.getPublicKey(), ks2.getPublicKey());
        final KeyStore ks3 = new KeyStore(this.cryptoProvider, bytes, RandomHelper.pseudoRandomBytes(32));
        final KeyStore ks4 = new KeyStore(this.cryptoProvider, hex, hex);
        assertArrayEquals(ks3.getPublicKey(), ks4.getPublicKey());
    }

    @Test
    public void testHexKeys() throws CryptoException {
        ...
        this.ks = new KeyStore(this.cryptoProvider, skHex);
